...
Командам перемещения добавить защиту от выезда за границы экрана.
Полет пули номер 1 или номер 2 из дула танка на сколько-то пикселей.
Взрыв и исчезновение танка 1 или танка 2.
"""
